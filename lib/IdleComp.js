...
const requestIdleCallback = global.requestIdleCallback || ((callback) => global.setTimeout(callback, 0))
const cancelIdleCallback = global.cancelIdleCallback || global.clearTimeout
